...
import pion.tech.pionbase.feature.home.domain.model.template.TemplateModelData
...
interface ApiInterface {
    ...
    suspend fun getAllTemplate(@Query("category_id") categoryId: String): ApiObjectResponseData<List<TemplateModelData>>
}