...
import pion.tech.pionbase.app.presentation.dialog.LoadingDialog
...
class MainActivity : AppCompatActivity() {
    ...
    fun showLoading() {
        LoadingDialog.Companion.getInstance().show(supportFragmentManager)
    }

    fun hiddenLoading() {
        LoadingDialog.Companion.getInstance().dismiss()
    }
