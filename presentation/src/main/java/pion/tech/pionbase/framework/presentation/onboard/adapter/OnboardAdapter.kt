package pion.tech.pionbase.framework.presentation.onboard.adapter
...
import pion.tech.pionbase.framework.presentation.onboard.viewpager.OnboardViewHolder1
import pion.tech.pionbase.framework.presentation.onboard.viewpager.OnboardViewHolder2
import pion.tech.pionbase.framework.presentation.onboard.viewpager.OnboardViewHolder3
import pion.tech.pionbase.framework.presentation.onboard.viewpager.OnboardViewHolder4
import pion.tech.pionbase.framework.presentation.onboard.viewpager.OnboardViewHolder5
...
class OnboardAdapter : RecyclerView.Adapter<OnboardAdapter.OnboardViewHolder>() {
    ...
    init {
        listClassName.add(OnboardViewHolder1::class.java.name)
